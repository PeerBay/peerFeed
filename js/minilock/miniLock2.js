...
miniLock.util.getRandomCredentials = function() {
...
miniLock.crypto.encryptedMessageCallback = function(cipher, senderID) {
	miniLock.UI.messageOperationIsComplete({
		data: cipher,
		type: 'text/minilock'
...
//~ 	,{magnet_link:""}]
//~ }
// attachments are uploaded encrypted with minilock and then shared using
// torrent with ssl certificates and client ssl certificate is included in the message.
miniLock.crypto.encryptMessage = function(
	message,
	miniLockIDs,
	myMiniLockID,
	mySecretKey,
